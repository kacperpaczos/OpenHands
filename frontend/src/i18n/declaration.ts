...
export enum I18nKey {
  ...
  ARTIFACTS$EMPTY_HINT = "ARTIFACTS$EMPTY_HINT",
  ARTIFACTS$DOWNLOAD = "ARTIFACTS$DOWNLOAD",
  ARTIFACTS$PREVIEW = "ARTIFACTS$PREVIEW",
  ARTIFACTS$PREVIEW_ERROR = "ARTIFACTS$PREVIEW_ERROR",
  ARTIFACTS$GENERATED_IMAGE = "ARTIFACTS$GENERATED_IMAGE",
